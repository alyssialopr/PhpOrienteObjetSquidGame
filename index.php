...
class Game
{
    ...
    {
        $enemy1 = new Mechant("Hermione", rand(1, 20), rand(18, 90));
    ...
    { //choisir une difficulté aléatoirement
        ...
        if ($randomDifficulty == "Facile") {
            $niveau = 5;
        } elseif ($randomDifficulty == "Difficile") {
            $niveau = 10;
        } else {
            $niveau = 20;
        }
        ...
        $i = 0;
        while ($randomHero->getBilles() > 0 && $i < 5) {
            ...
            echo $randomEnemy->getName() . " a " . $randomEnemy->getAge() . " ans et possède " . $randomEnemy->getBilles() . " billes";
            echo "<br>";
            $guess = Utils::generateRandomNumber(0, 1);
            if ($guess == 0) {
                echo "Le héros a choisi pair";
                if ($randomEnemy->getBilles() % 2 == 0) {
                    $randomHero->setBilles($randomHero->getBilles() + $randomHero->getBonus() + $randomEnemy->getBilles());
                    echo "<br>";
                    echo $randomHero->getName() . " a gagné";
                    echo "<br>";
                    echo "Il lui reste " . $randomHero->getBilles() . " billes";
                    echo "<br><br>";
                } else {
                    $randomHero->setBilles($randomHero->getBilles() - $randomHero->getMalus() - $randomEnemy->getBilles());
                    echo "<br>";
                    echo $randomHero->getName() . " a perdu";
                    echo "<br>";
                    echo "Il lui reste " . $randomHero->getBilles() . " billes";
                    echo "<br><br>";
                }
